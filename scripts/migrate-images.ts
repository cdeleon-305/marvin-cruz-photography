...
async function migrate() {
  ...
  if (portfolioError) {
    console.error("Portfolio insert error:", portfolioError.message);
  } else {
    console.log(`Inserted ${portfolioRows.length} portfolio images.`);
  }
  ...
  if (carouselError) {
    console.error("Carousel insert error:", carouselError.message);
  } else {
    console.log(`Inserted ${carouselRows.length} carousel images.`);
  }
